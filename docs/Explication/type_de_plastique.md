...
Le **PLA** (Acide Polylactique) est le matériau le plus courant en impression 3D. Il est simple à imprimer, offre une bonne qualité de surface et dégage peu d'odeur pendant l'impression. Il est idéal pour les pièces de rangement, les prototypes ou les objets décoratifs. En revanche, il résiste mal aux températures élevées.
...
L'**ABS** est un plastique très résistant utilisé dans de nombreux produits du quotidien. Il supporte bien la chaleur et les chocs, mais son impression est plus complexe car il est sensible au warping et nécessite généralement une imprimante fermée.
...
Le **TPU** est un matériau flexible. Contrairement aux autres filaments, il permet d'imprimer des pièces souples capables de se déformer sans casser.
...
| Matériau | Facilité d'impression | Résistance | Flexibilité | Utilisation extérieure |
|-----------|----------------------|------------|-------------|------------------------|
| PLA | ⭐⭐⭐⭐⭐ | ⭐⭐☆☆☆ | Non | Non |
| PETG | ⭐⭐⭐⭐☆ | ⭐⭐⭐⭐☆ | Faible | Oui |
| ABS | ⭐⭐☆☆☆ | ⭐⭐⭐⭐⭐ | Non | Moyenne |
...
Pendant mon stage, les impressions ont été réalisées exclusivement en **PLA**. Ce matériau est parfaitement adapté au projet de rangement Gridfinity car il est facile à imprimer, suffisamment résistant pour des bacs de stockage et permet d'obtenir rapidement des pièces de bonne qualité. 
