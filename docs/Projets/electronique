...
Le but de cette mission était d'apprendre à récupérer des composants présents sur une carte électronique grâce au brasage et au dessoudage. Mais aussi de vérifier si le matériels fonctionner.
...
J'ai utilisé du matériel de brasage afin de retirer les composants présents sur une carte électronique.
...
![Récupération d'un composant électronique](../assets/images/projet-electronique/brasage.jpg)

*Récupération d'un composant sur une carte électronique.*
