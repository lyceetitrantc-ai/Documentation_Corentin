...
Une partie importante du projet consistait à utiliser le système [Gridfinity](../definitions/#gridfinity) afin de créer des rangements adaptés aux tiroirs existants.
...
J'ai préparé les fichiers avec [OrcaSlicer](../definitions/#orcaslicer), puis lancé plusieurs impressions afin de produire l'ensemble des éléments.
